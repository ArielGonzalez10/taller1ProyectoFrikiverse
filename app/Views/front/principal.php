...
<div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="assets/img/Mangas/akamegakill01.jpg" class="d-block img-fluid mx-auto" alt="Akame Ga Kill Vol. 1">
        </div>
        <div class="carousel-item">
            <img src="assets/img/Mangas/chainsawman01.jpg" class="d-block img-fluid mx-auto" alt="Akame Ga Kill Vol. 2">
        </div>
        <div class="carousel-item">
            <img src="assets/img/Mangas/deathnote01.jpg" class="d-block img-fluid mx-auto" alt="Akame Ga Kill Vol. 3">
        </div>
    </div>
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-4 col-lg-3">
            <div class="product-item">
                <img src="assets/img/Mangas/deathnote01.jpg" alt="Manga" class="img-fluid">
                <div class="product-details">
                    <h2 class="product-title">
